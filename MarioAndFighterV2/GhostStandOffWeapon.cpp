...
#include <list>
#include "Monster.h"
GhostStandOffWeapon::~GhostStandOffWeapon()
{
	if (m_missile)
		delete m_missile;
}

void GhostStandOffWeapon::Update(Map* _map, Player* player)
{
	m_pos.x += m_hPower;
...
void GhostStandOffWeapon::Render(GameWnd* _wnd, Player* player)
{
